/*
 * @Author: GZH
 * @Date: 2021-07-21 15:13:02
 * @LastEditors: GZH
 * @LastEditTime: 2021-07-21 15:34:57
 * @FilePath: \my-app\src\pages\bigData\index.js
 * @Description:
 */
...
//     }
// }
// TODO: 改造方案   把大数据的显示分成不同的组件，不停的新增组件，减少diff的压力， 浏览器回流重塑的压力 dom 操作的压力.....
class Index extends React.Component {
  state = {
    dataList: [], //数据源列表
    renderList: [], //渲染列表
