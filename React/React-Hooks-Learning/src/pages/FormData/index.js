  ...
  return (
    <div style={{ marginTop: '50px' }}>
      <Form ref={form}>
        ...
        <FormItem label='年龄' labelWidth={150} name='age' required>
          <Input placeholder='请输入年龄' />
        </FormItem>
        <FormItem label='你最喜欢的前端框架' labelWidth={150} name='likes' required>
          <Select defaultValue={null} placeholder='选择你喜欢的前端框架' width={120}>
      ...
      <div>
        {' '}
        <button className='searchbtn'>获取表单数层</button>
      </div>
      <div></div>
    </div>
  );
